...
INSERT INTO sqlab_metadata (name, value) VALUES
  ('activities', '{"1": {"kind": "adventure", "label": "Adventure", "activity_number": 1, "title": "SQLab Island", "intro": "", "tasks": [{"access": "042", "task_number": 1, "task_title": "`SELECT *`", "formula": "salt_042(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 2, "task_title": "`SELECT *`", "formula": "salt_002(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 3, "task_title": "Comparison operator `=`", "formula": "salt_048(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 4, "task_title": "Comparison operator `=`", "formula": "salt_023(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 5, "task_title": "Boolean operator `AND`", "formula": "salt_060(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 6, "task_title": "Comparison operator `LIKE`", "formula": "salt_069(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 7, "task_title": "`INSERT`", "formula": "salt_090(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 8, "task_title": "Comparison operator `=`", "formula": "salt_099(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 9, "task_title": "`IS NULL`", "formula": "salt_073(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 10, "task_title": "`UPDATE` one row", "formula": "salt_093(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 11, "task_title": "`UPDATE` several rows", "formula": "salt_033(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 12, "task_title": "`UPDATE` several rows", "formula": "salt_025(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 13, "task_title": "Complex condition", "formula": "salt_024(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 14, "task_title": "`UPDATE` two rows", "formula": "salt_034(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 15, "task_title": "Transfer some gold", "formula": "salt_091(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 16, "task_title": "Transfer some gold", "formula": "salt_075(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 17, "task_title": "Transfer some gold", "formula": "salt_076(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 18, "task_title": "`UPDATE` the name of the stranger", "formula": "salt_080(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 19, "task_title": "`ORDER BY`", "formula": "salt_078((0) + sum(nn(hash)) OVER ()) AS token", "tweak_javascript": "result[0][result[0].length - 2]"}, {"access": false, "task_number": 20, "task_title": "`ORDER BY`", "formula": "salt_010(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 21, "task_title": "`ORDER BY`", "formula": "salt_086(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 22, "task_title": "Joins", "formula": "salt_029(sum(nn(A.hash) + nn(B.hash)) OVER ()) AS token"}, {"access": false, "task_number": 23, "task_title": "Joins", "formula": "salt_045(sum(nn(A.hash) + nn(B.hash)) OVER ()) AS token"}, {"access": false, "task_number": 24, "task_title": "`COUNT(*)`", "formula": "salt_012(sum(avg(nn(A.hash) + nn(B.hash))) OVER ()) AS token"}, {"access": false, "task_number": 25, "task_title": "`COUNT(*)`", "formula": "salt_032((0) + sum(avg(nn(A.hash) + nn(B.hash))) OVER ()) AS token", "tweak_javascript": "result[0][0]"}, {"access": false, "task_number": 26, "task_title": "`COUNT(*)`", "formula": "salt_036(sum(nn(A.hash) + nn(B.hash)) OVER ()) AS token"}, {"access": false, "task_number": 27, "task_title": "`SUM()`", "formula": "salt_035(sum(avg(nn(A.hash) + nn(B.hash))) OVER ()) AS token"}, {"access": false, "task_number": 28, "task_title": "`SUM()`", "formula": "salt_046((0) + sum(avg(nn(hash))) OVER ()) AS token", "tweak_javascript": "result[0][0]"}, {"access": false, "task_number": 29, "task_title": "`AVG()`", "formula": "salt_071(sum(avg(nn(hash))) OVER ()) AS token"}, {"access": false, "task_number": 30, "task_title": "`DELETE`", "formula": "salt_018(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 31, "task_title": "`DELETE`", "formula": "salt_004(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 32, "task_title": "Epilog", "formula": "salt_051(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 33, "task_title": "Epilog", "formula": "salt_052(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 34, "task_title": "Epilog", "formula": "salt_053(sum(nn(hash)) OVER ()) AS token"}, {"access": false, "task_number": 35, "task_title": "Epilog"}], "task_count": 35}}'),
  ...
  ('created_at', '"2025-05-16T19:31:50.300491"'),
  ('dbms', '"MariaDB"'),
  ...
  ('title', '"SQLab Island"'),
  ('version', '"3.1.0"'),
  ('web_toc', '["<div class=''activity''><h2>Adventure: SQLab Island</h2><div class=''section''><h3>`SELECT *`</h3><ul><li><div class=''number''>1</div></li></ul>\\n</div></div>"]')
;
